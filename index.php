            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-sm-7 col-12 col-2" data-aos="fade-left" data-aos-delay="300">
                    ...
                    <div class="more-button">
                        ...
                        <a href="disp_Esession.php" class="btn btn-primary btn-lg">view sessions</a>
                    </div>
    ...
    <footer>
        ...
        <div class="container">
            ...
            <div class="row text-center d-flex justify-content-center">
                ...
                <div class="col-md-12">
                    ...
                    <ul>
                        ...
                        <li class="hidden">|</li>
                        <li class="nav-item"><a class="page-scroll nav-link" href="judgelogin.html">Judge login</a></li>
                    </ul>
                </div>
            </div>
            <!-- Grid row-->
            <div class="row d-flex text-center justify-content-center mb-md-0">
              ...
              <span>Opening Hours : Mon-Fri 11 am-11 pm, Sat-Sun 10 am- 11pm</span>
