               ...
               <div class="row">
                <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
                   ...
                   <p data-aos="fade-up" data-aos-delay="500">
                     <span>A team consists of a main designer and two co designers </span>
                   </p>
                ...
                {  
                     echo '  
                          <tr>  
                               <td>  
                                    <img src="data:image/jpeg;base64,'.base64_encode($row['pimg'] ).'" height="200" width="200" class="img-thumnail" /> <br> 
                               </td>  
                          </tr>  
                      poster id  '. $row["pid"] . "<br> poster name :". $row["pname"] . "<br>";  
                }  
                ?>  
                    <form method="POST" action="php/test.php" target="_self>
